      ...
      <div className="relative z-10 flex h-full items-center px-6 md:px-12">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-xs md:text-sm backdrop-blur-md ring-1 ring-white/20">
            ...
            Live at FlamesBlue • Canteen Management
          </div>
          <h1 className="mt-4 text-3xl md:text-5xl font-extrabold tracking-tight">
            Smart, Fast, and Flavorful Canteen Experience
          </h1>
          <p className="mt-3 md:mt-4 text-sm md:text-base text-slate-300">
            Explore a modern menu, add items to your cart, and enjoy seamless ordering. Built with an AI-ready foundation and the FlamesBlue design aesthetic.
          </p>
          <div className="mt-6 flex flex-wrap gap-3">
            <a
              href="#menu"
              className="inline-flex items-center justify-center rounded-xl bg-cyan-500 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-cyan-500/25 transition hover:-translate-y-0.5 hover:bg-cyan-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300"
            >
              Browse Menu
            </a>
            <a
